...
// Função para salvar as tarefas no localStore.
...
function saveTasks(){
 ...
 function renderTasks() {
     ...
     tasks.forEach((taskText, index) => {
         ...
         //Adiciona o ite <li> completo na lista <ul>
 ...
 function addTask() {
     const taskText = taskInput.value.trim(); //Pega o texto e remove os espaços em branco
     if (taskText) {                      //Verifica se o texto não está vazio
         tasks.push(taskText);            //Adiciona a tarefa ao nosso array
 ...
 function removeTask(index) {
    ...
    if (confirm(confirmationMessage)) {
        ...
        //Salva o novo estado doarray no localStorage.
        saveTasks();
 ...
 //Adicionar o "ouvinte do evento" para o botão. A função addTask será chamada ao clicar.
...
//Renderiza as taferas que já estavam salvas assim que a página carrega
renderTasks();
